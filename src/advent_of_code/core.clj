...
(defn -main
  ...
  (case part
    ...
    "d05bis.p1" (println (advent-of-code.day05bis/part-1
                          (read-input "day05.txt")))
    "d05bis.p2" (println (advent-of-code.day05bis/part-2
                          (read-input "day05.txt")))
    ...
    "d08bis.p1" (println (advent-of-code.day08bis/part-1
                          (read-input "day08.txt")))
    "d08bis.p2" (println (advent-of-code.day08bis/part-2
                          (read-input "day08.txt")))
    ...
    "d10bis.p1" (println (advent-of-code.day10bis/part-1
                          (read-input "day10.txt")))
    "d10bis.p2" (println (advent-of-code.day10bis/part-2
                          (read-input "day10.txt")))
    ...
    "d12bis.p1" (println (advent-of-code.day12bis/part-1
                          (read-input "day12.txt")))
    "d12bis.p2" (println (advent-of-code.day12bis/part-2
                          (read-input "day12.txt")))
    ...
    "d14bis.p1" (println (advent-of-code.day14bis/part-1
                          (read-input "day14.txt")))
    "d14bis.p2" (println (advent-of-code.day14bis/part-2
                          (read-input "day14.txt")))
    ...
    "d17bis.p1" (println (advent-of-code.day17bis/part-1
                          (read-input "day17.txt")))
    "d17bis.p2" (println (advent-of-code.day17bis/part-2
                          (read-input "day17.txt")))
    ...
    "d19bis.p1" (println (advent-of-code.day19bis/part-1
                          (read-input "day19.txt")))
    "d19bis.p2" (println (advent-of-code.day19bis/part-2
                          (read-input "day19.txt")))
    ...
    "d22bis.p1" (println (advent-of-code.day22bis/part-1
                          (read-input "day22.txt")))
    "d22bis.p2" (println (advent-of-code.day22bis/part-2
                          (read-input "day22.txt")))
    ...
    "d23bis.p1" (println (advent-of-code.day23bis/part-1
                          (read-input "day23.txt")))
    "d23bis.p2" (println (advent-of-code.day23bis/part-2
                          (read-input "day23.txt")))
